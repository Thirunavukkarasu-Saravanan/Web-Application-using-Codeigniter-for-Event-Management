<div id="contactomain">
    	<img id="contactoimg" src="<?php echo base_url(); ?>imagenes/bannerabout.jpg">
    	<div id="contactoquo"> <h1> QUIENES SOMOS <h1> </div>
    	<div id="contactoquot"> 
    		<span class="quenesinpic"> <a href="<?php echo base_url(); ?>lean/home" > INICIO </a> </span>
    		<span class="quenesinpic"> <a href="<?php echo base_url(); ?>lean/quenes" > QUIENES SOMOS </a> </span>
    	</div>
    	<div id="content_about_us">
				<div id="about_us_left">
    				<p>
    					<h3 class="about_us_headers">Qué es LEAN</h3>
							LEAN es una asociación civil sin fines de lucro conformada por gente con gran sensibilidad social, dedicada a la defensa de los derechos humanos y la consecución de ayuda humanitaria, favoreciendo directamente o a través de otras asociaciones o agrupaciones provinciales a venezolanos residentes en España y a quienes viven en Venezuela.<br>
						<h3 class="about_us_headers">Cuáles son los fines de LEAN</h3>
							LEAN está dedicada a fomentar valores e instaurarlos como principios, trabajar en formación cívica, promover y defender las libertades individuales y los derechos humanos en Venezuela, sensibilizar a la gente sobre la importancia de conocer, respetar y practicar los principios contenidos en la Declaración Universal de Derechos Humanos, asistir a víctimas de actos violentos y persecución, favorecer la adquisición de conocimiento a través de la lectura y trabajar incansablemente en la ayuda humanitaria como gesto de solidaridad y buena voluntad.<br>
						<h3 class="about_us_headers">Cuáles son las actividades de LEAN</h3>
						<p>
							LEAN trabaja en el desarrollo y publicación de estudios de investigación sobre temas de interés social, cultural, político y económico, preparación de ponencias para foros y conferencias, presentación en eventos especializados y mesas de trabajo, petición de colaboración a personalidades de reconocida trayectoria, estudio de casos de violación de derechos humanos a través de letrados voluntarios, asistencia y representación para la defensa de las víctimas de actos violentos y persecución, lanzamiento de campañas sobre valores cívicos y derechos humanos, planificación y ejecución de programas de voluntariado para brindar ayuda humanitaria y organización de charlas sobre la situación económica, política y social de Venezuela y demás temas de interés mundial.<br>
						</p>
						<h3 class="about_us_headers">Qu hacemos</h3>
						<p>
				...
				<div id="about_us_right">
					<h3 class="about_us_headers">Como puedes ayudar?<br>
					<p>Puedes ayudar de tres formas:</p>
					</h3><p>
							•	Dona material médico e insumos para Venezuela.<br>
							•	A través de donaciones económicas<br>
	    						•	Hazte voluntario.<br>
	    				 </p>
					<h3 class="about_us_headers">Donde estamos?<br>
	    				Somos 17 Coordinacines en ESPAÑA:</h3>
						Alicante - Almería - Cataluña - Granada - Islas Canarias - Islas Baleares - León - Madrid -Málaga - Salamanca - Sevilla - Valencia - Valladolid - Zaragoza - LEAN EEUU.<br>
					<h3>Instituciones y Organizaciones Beneficiadas en<br> VENEZUELA:<br></h3>
						Ayudamos a 11 Estados a través de 35 puntos de destino:<br>
					<ul class="quenosmoslistl">
