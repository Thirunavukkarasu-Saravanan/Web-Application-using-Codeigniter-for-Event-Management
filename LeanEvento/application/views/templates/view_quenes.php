<div id="contactomain">
    	<img id="contactoimg" src="imagenes/bannerabout.jpg">
    	<div id="contactoquo"> <h1> QUIENES SOMOS <h1> </div>
    	<div id="contactoquot"> 
    		<span class="quenesinpic"> <a href="inciar.php" > INICIO </a> </span>
    		<span class="quenesinpic"> <a href="comprarboletos.php" > QUIENES SOMOS </a> </span>
    	</div>
